(function (exports) {
    ...
    */
    ...
    function shouldUseClientSideRouting() {
        return hasInteractiveRouter() || true;
    }
    ...
    let noHeapLock = { release: () => { } };
    class NetJsPlatform {
        load(options, onConfigLoaded) {
        ...
        getArrayEntryPtr(array, index, itemSize) {
            return null;
        }
        getObjectFieldsBaseAddress(referenceTypedObject) {
            return null;
        }
        readInt16Field(baseAddress, fieldOffset) {
            throw new Error('Method not implemented.');
        }
        readInt32Field(baseAddress, fieldOffset) {
            throw new Error('Method not implemented.');
        }
        readUint64Field(baseAddress, fieldOffset) {
            throw new Error('Method not implemented.');
        }
        readObjectField(baseAddress, fieldOffset) {
            throw new Error('Method not implemented.');
        }
        readStringField(baseAddress, fieldOffset, readBoolValueAsString) {
            throw new Error('Method not implemented.');
        }
        readStructField(baseAddress, fieldOffset) {
            throw new Error('Method not implemented.');
        }
        beginHeapLock() {
            return noHeapLock;
        }
        invokeWhenHeapUnlocked(callback) {
        }
    }
    let netJsPlatform = new NetJsPlatform();

    class NetJsRenderBatch {
        constructor(batch) {
            ...
            this.netjsBatch = batch.$v;
        }
        updatedComponents() {
            return this.netjsBatch.UpdatedComponents;
        }
        referenceFrames() {
            return this.netjsBatch.ReferenceFrames;
        }
        disposedComponentIds() {
            return this.netjsBatch.DisposedComponentIDs;
        }
        disposedEventHandlerIds() {
            return this.netjsBatch.DisposedEventHandlerIDs;
        }
    ...
    const arrayRangeReader = {
        structLength: 8,
        values: (arrayRange) => arrayRange.Array,
        count: (arrayRange) => arrayRange.Count
    };
    ...
    const arrayBuilderSegmentReader = {
        ...
        values: (arrayBuilderSegment) => {
            ...
            var netjsSegment = arrayBuilderSegment;
            return netjsSegment._builder._items;
        },
        offset: (arrayBuilderSegment) => {
            var netjsSegment = arrayBuilderSegment;
            return netjsSegment._offset;
        },
        count: (arrayBuilderSegment) => {
            var netjsSegment = arrayBuilderSegment;
            return netjsSegment._count;
        }
    };
    ...
    const diffReader = {
        ...
        componentId: (diff) => {
            var netjsTreeDiff = diff;
            return netjsTreeDiff.ComponentId;
        },
        edits: (diff) => {
            var netjsTreeDiff = diff;
            return netjsTreeDiff.Edits;
        },
    ...
    const editReader = {
        structLength: 20,
        editType: (edit) => {
            var netjsTreeEdit = edit;
            return netjsTreeEdit.Type;
        },
        siblingIndex: (edit) => {
            var netjsTreeEdit = edit;
            return netjsTreeEdit.SiblingIndex;
        },
        newTreeIndex: (edit) => {
            var netjsTreeEdit = edit;
            return netjsTreeEdit.ReferenceFrameIndex;
        },
        moveToSiblingIndex: (edit) => {
            var netjsTreeEdit = edit;
            return netjsTreeEdit.MoveToSiblingIndex;
        },
        removedAttributeName: (edit) => {
            var netjsTreeEdit = edit;
            return netjsTreeEdit.RemovedAttributeName;
        },
    };
    ...
    const frameReader = {
        structLength: 36,
        frameType: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.FrameType;
        },
        subtreeLength: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.ElementSubtreeLength;
        },
        elementReferenceCaptureId: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.ElementReferenceCaptureId;
        },
        componentId: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.ComponentId;
        },
        elementName: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.ElementName;
        },
        textContent: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.TextContent;
        },
        markupContent: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.MarkupContent;
        },
        attributeName: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.AttributeName;
        },
        attributeValue: (frame) => {
            var netjsTreeFrame = frame;
            return netjsTreeFrame.AttributeValue;
        },
        attributeEventHandlerId: (frame) => {
            var netjsTreeFrame = frame;
            let value = netjsTreeFrame.AttributeEventHandlerId;
    ...
    function isFirstUpdate() {
        return firstUpdate;
    }
    function setWaitForRootComponents() {
    ...
    async function startCore(components, options, resolve, _) {
        ...
        exports.dispatcher = DotNet.attachDispatcher({
        ...
        Blazor._internal.updateRootComponents = updateRootComponent;
        let netjs = window.NetJs;
        Blazor._internal.dotNetExports = {
            InvokeDotNet: netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_InvokeDotNet,
            BeginInvokeDotNet: netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_BeginInvokeDotNet,
            EndInvokeJS: netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_EndInvokeJS,
            UpdateRootComponentsCore: netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_UpdateRootComponentsCore,
            ReceiveByteArrayFromJS: netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_ReceiveByteArrayFromJS,
        };
        // Configure environment for execution under Mono WebAssembly with shared-memory rendering
        const platform = setPlatform(netJsPlatform);
        ...
        Blazor._internal.renderBatch = (browserRendererId, batchAddress) => {
            ...
            const heapLock = platform.beginHeapLock();
            try {
                renderBatch(browserRendererId, new NetJsRenderBatch(batchAddress));
            }
            finally {
                heapLock.release();
            }
        ...
        Blazor._internal.navigationManager.listenForNavigationEvents(WebRendererId.WebAssembly, async (uri, state, intercepted) => {
            await exports.dispatcher.invokeDotNetStaticMethodAsync('Microsoft.AspNetCore.Components.WebAssembly', 'NotifyLocationChanged', uri, state, intercepted);
        }, async (callId, uri, state, intercepted) => {
            const shouldContinueNavigation = await exports.dispatcher.invokeDotNetStaticMethodAsync('Microsoft.AspNetCore.Components.WebAssembly', 'NotifyLocationChangingAsync', uri, state, intercepted);
    ...
    function hasStartedWebAssembly() {
        return startPromise !== undefined;
    }
    function waitForBootConfigLoaded() {
    ...
    function loadWebAssemblyPlatformIfNotStarted(serverOptions) {
        platformLoadPromise ??= (async () => {
            ...
            await netJsPlatform.load(finalOptions, resolveBootConfigPromise);
            loadedWebAssemblyPlatform = true;
        })();
        return platformLoadPromise;
    }
    function hasStartedLoadingWebAssemblyPlatform() {
        return platformLoadPromise !== undefined;
    }
    function hasLoadedWebAssemblyPlatform() {
        return loadedWebAssemblyPlatform;
    }
    function updateWebAssemblyRootComponents(operations, webAssemblyState) {
        if (!startPromise) {
    ...
    async function scheduleAfterStarted(operations, webAssemblyState) {
        await startPromise;
        if (!Blazor._internal.updateRootComponents) {
            throw new Error('Blazor WebAssembly has not initialized.');
        }
    ...
    function invokeJSJson(identifier, targetInstanceId, resultType, argsJson, asyncHandle, callType) {
        if (typeof (asyncHandle) == "bigint")
            asyncHandle = Number(asyncHandle);
        if (asyncHandle !== 0) {
            exports.dispatcher.beginInvokeJSFromDotNet(asyncHandle, identifier, argsJson, resultType, targetInstanceId, callType);
            return null;
        }
        else {
            return exports.dispatcher.invokeJSFromDotNet(identifier, argsJson, resultType, targetInstanceId, callType);
        }
    }
    function endInvokeDotNetFromJS(callId, success, resultJsonOrErrorMessage) {
        exports.dispatcher.endInvokeDotNetFromJS(callId, success, resultJsonOrErrorMessage);
    }
    function receiveWebAssemblyDotNetDataStream(streamId, data, bytesRead, errorMessage) {
        if (typeof (streamId) == "bigint")
            streamId = Number(streamId);
        receiveDotNetDataStream(exports.dispatcher, streamId, data, bytesRead, errorMessage);
    }
    function receiveByteArray(id, data) {
        if (typeof (id) == "bigint")
            id = Number(id);
        exports.dispatcher.receiveByteArray(id, data);
    }
    function invokeDotNetFromJS(assemblyName, methodIdentifier, dotNetObjectId, argsJson) {
        //Statically Call DefaultWebAssemblyJsRuntime.InvokeDotNet(assemblyName, methodIdentifier, dotNetObjectId, argsJson)
        let netjs = window.NetJs;
        let result = netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_InvokeDotNet(assemblyName, methodIdentifier, BigInt(dotNetObjectId || 0), argsJson);
        return result;
    }
    function beginInvokeDotNetFromJS(callId, assemblyName, methodIdentifier, dotNetObjectId, argsJson) {
        //Statically Call DefaultWebAssemblyJsRuntime.BeginInvokeDotNet(callId, assemblyNameOrDotNetObjectId, methodIdentifier, argsJson)
        let netjs = window.NetJs;
        netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_BeginInvokeDotNet(callId ? callId.toString() : null, assemblyName ?? dotNetObjectId?.toString(), methodIdentifier, argsJson);
    }
    function endInvokeJSFromDotNet(asyncHandle, succeeded, argsJson) {
        //Statically Call DefaultWebAssemblyJsRuntime.EndInvokeJS(argJson)
        // let json = JSON.stringify({ taskId: asyncHandle, succeeded: succeeded, argsJson: argsJson });
        let netjs = window.NetJs;
        netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_EndInvokeJS(argsJson);
    }
    function sendByteArray(id, data) {
        //Statically Call DefaultWebAssemblyJsRuntime.ReceiveByteArrayFromJS(id, data)
        var bArray = Array.from(data);
        let netjs = window.NetJs;
        netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_ReceiveByteArrayFromJS(id, bArray);
    }
    function updateRootComponent(operations, webAssemblyState) {
        //Statically Call DefaultWebAssemblyJsRuntime.UpdateRootComponentsCore(operationsJson, appState)
        let netjs = window.NetJs;
        netjs.$exports.Microsoft_AspNetCore_Components_WebAssembly_Services_DefaultWebAssemblyJSRuntime_UpdateRootComponentsCore(operations, webAssemblyState);
    }
    ...
    exports.beginInvokeDotNetFromJS = beginInvokeDotNetFromJS;
    exports.endInvokeJSFromDotNet = endInvokeJSFromDotNet;
    exports.hasLoadedWebAssemblyPlatform = hasLoadedWebAssemblyPlatform;
    exports.hasStartedLoadingWebAssemblyPlatform = hasStartedLoadingWebAssemblyPlatform;
    exports.hasStartedWebAssembly = hasStartedWebAssembly;
    exports.invokeDotNetFromJS = invokeDotNetFromJS;
    exports.isFirstUpdate = isFirstUpdate;
    exports.loadWebAssemblyPlatformIfNotStarted = loadWebAssemblyPlatformIfNotStarted;
    exports.resolveInitialUpdate = resolveInitialUpdate;
    exports.sendByteArray = sendByteArray;
    exports.setWaitForRootComponents = setWaitForRootComponents;
    exports.setWebAssemblyOptions = setWebAssemblyOptions;
    exports.startWebAssembly = startWebAssembly;
    exports.updateRootComponent = updateRootComponent;
    exports.updateWebAssemblyRootComponents = updateWebAssemblyRootComponents;
    exports.waitForBootConfigLoaded = waitForBootConfigLoaded;

    return exports;

})({});
//# sourceMappingURL=blazor.netjs.js.map
