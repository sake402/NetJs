...
namespace System
{
    internal static partial class SpanHelpers
    {
        ...
        internal static unsafe void MemmoveImpl(ref byte dest, ref byte src, nuint len)
        {
            void* ddest = Unsafe.AsPointer<byte>(ref dest);
            void* ssrc = Unsafe.AsPointer<byte>(ref src);
            Unsafe.CopyBlockFinal(ddest, ssrc, len);
        }
